                    ...
                    <div class="lg:col-span-4">
                        <div class="flex flex-col min-h-screen md:px-12 py-12 px-3">
                            ...
                            <div class="text-center mx-auto">
                                <NuxtLink to="/"><img src="assets/images/logo-light.png" alt=""></NuxtLink>
                            </div>
                            <!-- End Logo -->
                                    ...
                                    <div class="grid grid-cols-1">
                                        ...
                                        <form class="ltr:text-left rtl:text-right">
                                            <div class="grid grid-cols-1">
                                                ...
                                                <div class="mb-4">
                                                    <a href="" class="btn bg-orange-600 hover:bg-orange-700 border-orange-600 hover:border-orange-700 text-white rounded-md w-full">Login / Sign in</a>
                                                </div>
