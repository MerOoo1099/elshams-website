    ...
    <div class="container flex flex-wrap items-center justify-end">
      ...
      <div class="nav-icons flex items-center lg_992:order-2 ms-auto">
        ...
        <ul class="list-none menu-social mb-0">
          <li class="inline">
            <a
              href="https://www.facebook.com/elshamsforfinishingandconstruction?mibextid=ZbWKwL"
              class="btn btn-sm btn-icon rounded-full bg-primary hover:bg-primary border-third hover:border-primary text-secondary"
