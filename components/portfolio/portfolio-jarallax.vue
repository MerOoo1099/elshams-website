<template>
  <div>
    ...
    >
      <div class="container">
        <div class="grid grid-cols-1 pb-8 text-center">
          <h6 class="text-primary text-base font-medium uppercase mb-2">
            {{$t('Portfolio')}}
          </h6>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-6 mt-8">
          <div
            ...
            :key="item"
            class="relative rounded-md shadow-sm overflow-hidden group"
          >
            <img
              :src="item.image"
            ...
            />
            <div
              class="absolute inset-0 group-hover:bg-black opacity-50 transition duration-500 z-0"
            ></div>
            ...
            <div class="content">
              ...
              >
                <a
                  @click="showMultiple"
                  class="btn bg-primary hover:bg-primary border-primary hover:border-primary text-white btn-icon rounded-full lightbox"
                  ><i :class="item.icon"></i
                ></a>
              </div>
              ...
              >
                <NuxtLink
                  :to="localePath('/portfolio-detail')"
                  class="h6 text-md font-medium text-white hover:text-primary transition duration-500"
                  >{{ item.name }}</NuxtLink
                >
    ...
    <!-- Start -->
    <section
      class="py-24 w-full table relative bg-center bg-cover jarallax"
      data-jarallax
      data-speed="0.5"
      :style="{
      ...
      <div class="container relative">
        <div class="grid grid-cols-1 pb-8 text-center">
          ...
          <div class="relative mt-10">
            <a
              href=""
              class="btn bg-primary hover:bg-primary border-primary hover:border-primary text-white rounded-md"
              >Get Started !</a
            >
          </div>
        </div>
